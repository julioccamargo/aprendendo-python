...
PALAVRAS_CHAVE_SUPERIOR = [
    ...
    'marketing', 'publicidade', 'gestão comercial'
]

# --- 3. Configuração de Caminhos ---
DIRETORIO_ATUAL = Path(__file__).parent
PASTA_CURRICULOS = DIRETORIO_ATUAL / "curriculos_vendedor"
ARQUIVO_SAIDA_EXCEL = DIRETORIO_ATUAL / "Resultado_Triagem_VENDEDOR.xlsx"
ARQUIVO_HASHES = DIRETORIO_ATUAL / "hashes_processados_vendedor.txt"
